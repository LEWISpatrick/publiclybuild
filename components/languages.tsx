...
const Tooltip: React.FC<{ text: string; className?: string }> = ({
  text,
  className
}) => (
  <div
    className={`absolute bottom-full mb-2 w-40 p-2   text-sm rounded-md opacity-0 transition-opacity duration-300 ${className} pointer-events-none`}
  >
    {text}
  </div>
)
...
const GitHubIcon = () => (
  <div className="relative group w-32 h-32">
    ...
    <Tooltip
      text="Fetching 'Fixed Video Section' commit"
...
const ArrowIcon = () => (
  <div className="relative group w-32 h-32">
    ...
    <Tooltip
      text="Processing  'Fixed Video Section' commit through LLM"
      className="group-hover:opacity-100"
    />
  </div>
)
...
const Languages = () => {
  return (
    <div className=" h-46 mr-16 ml-16 pt-32">
